...
_INDEX_RST_BADGE_CODECOV = '''.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/updateidsforsm
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/updateidsforsm

'''
_INDEX_RST_BADGE_GITHUB_CI = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/updateidsforsm/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/updateidsforsm/actions/workflows/ci.yaml

'''
_INDEX_RST_BADGE_GITHUB_HITS = '''.. image:: https://img.shields.io/github/search/hendrikdutoit/updateidsforsm/GitHub hit
    :alt: GitHub Searches

'''
_INDEX_RST_BADGE_GITHUB_LICENSE = '''.. image:: https://img.shields.io/github/license/hendrikdutoit/updateidsforsm
    :alt: License

'''
_INDEX_RST_BADGE_GITHUB_ISSUES = '''.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/updateidsforsm
    :alt: GitHub issues

'''
_INDEX_RST_BADGE_GITHUB_PRE_COMMIT = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/updateidsforsm/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/updateidsforsm/actions/workflows/pre-commit.yaml

'''
_INDEX_RST_BADGE_GITHUB_RELEASE = '''.. image:: https://img.shields.io/github/v/release/hendrikdutoit/updateidsforsm
    :alt: GitHub release (latest by date)

'''
_INDEX_RST_BADGE_PYPI_VERSION = '''.. image:: https://img.shields.io/testpypi/v/updateidsforsm
    :alt: PyPi

'''
_INDEX_RST_BADGE_PYPI_DL = '''.. image:: https://img.shields.io/pypi/dm/updateidsforsm
    :alt: PyPI - Downloads

'''
_INDEX_RST_BADGE_PYPI_STATUS = '''.. image:: https://img.shields.io/pypi/status/updateidsforsm
    :alt: PyPI - Status

'''
_INDEX_RST_BADGE_PYPI_WHEEL = '''.. image:: https://img.shields.io/pypi/wheel/updateidsforsm
    :alt: PyPI - Wheel

'''
_INDEX_RST_BADGE_PYVERSIONS = '''.. image:: https://img.shields.io/pypi/pyversions/updateidsforsm
...
.. image:: https://img.shields.io/pypi/status/updateidsforsm
    :alt: PyPI - Status

.. image:: https://img.shields.io/pypi/wheel/updateidsforsm
    :alt: PyPI - Wheel

.. image:: https://img.shields.io/pypi/pyversions/updateidsforsm
    :alt: PyPI - Python Version

.. image:: https://img.shields.io/github/v/release/hendrikdutoit/updateidsforsm
    :alt: GitHub release (latest by date)

.. image:: https://img.shields.io/github/license/hendrikdutoit/updateidsforsm
    :alt: License

.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/updateidsforsm
    :alt: GitHub issues

.. image:: https://img.shields.io/pypi/dm/updateidsforsm
    :alt: PyPI - Downloads

.. image:: https://img.shields.io/github/search/hendrikdutoit/updateidsforsm/GitHub hit
    :alt: GitHub Searches

.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/updateidsforsm
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/updateidsforsm

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/updateidsforsm/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/updateidsforsm/actions/workflows/pre-commit.yaml

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/updateidsforsm/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/updateidsforsm/actions/workflows/ci.yaml

.. image:: https://img.shields.io/testpypi/v/updateidsforsm
    :alt: PyPi
